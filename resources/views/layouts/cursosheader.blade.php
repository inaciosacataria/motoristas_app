...
<head>
    ...
    <meta property="og:title" content="Formaçao de motoristas | motoristas.co.mz">
    <meta property="og:description" content="O portal de emprego, Base de dados e formação de motoristas">
    <meta property="og:image" content="assets/images/motoristas.png">
                            ...
                            <li class="list-inline-item dropdown notification-list nav-user">
                                @guest
                                    <a class="nav-link" href="#" data-toggle="modal"
                                        data-target=".bs-base-dados-modal-center">
