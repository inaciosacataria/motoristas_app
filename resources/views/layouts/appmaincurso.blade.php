...
<head>
    ...
    <meta name="description" content="Portal de emprego e formação de motoristas">
    <meta name="keywords"
    ...
    <meta property="og:url" content="motorista.co.mz">
    <meta property="og:title" content="Formações de Motoristas | motoristas.co.mz">
    <meta property="og:description" content="Portal de emprego, Base de dados e formação de motoristas">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="list-inline ml-auto mb-0 navbar-nav mr-auto">
                        ...
                        <li style="margin-right: 250px"
                            ...
                            @guest
                                <a class="nav-link" href="#" data-toggle="modal"
                                    data-target=".bs-central-risco-modal-center" style="color:#fff">
