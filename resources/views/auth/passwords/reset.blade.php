...
<head>
    ...
    <title>Redefinir Senha - Motoristas</title>
    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <h2 class="text-center text-3xl font-bold text-gray-900 mb-2">
                <i class="fas fa-lock text-green-600 mr-2"></i> Redefinir Senha
            </h2>
            <p class="mt-2 text-center text-base text-gray-600">
                Defina uma nova senha para continuar a usar a plataforma.
            </p>
        </div>
                ...
                <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="password" class="block text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-key text-green-600 mr-2"></i>Nova Senha
                        </label>
                        <input 
                            id="password" 
                            type="password"
                    ...
                    <div>
                        <label for="password-confirm" class="block text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-check text-green-600 mr-2"></i>Confirmar Senha
                        </label>
                        <input 
                            id="password-confirm" 
                            type="password" 
                            ...
                            required 
                            autocomplete="new-password"
                            class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 text-base transition duration-200"
                        >
                    </div>
                    ...
                    >
                        <i class="fas fa-sync-alt mr-2"></i> Redefinir Senha
                    </button>
