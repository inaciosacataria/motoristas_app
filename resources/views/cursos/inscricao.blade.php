    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-895f">
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <div class="u-form u-form-1">
                <form method="post" action="{{ route('submeter-inscricao') }}"
                    ...
                    <div class="u-form-group u-form-select u-label-none">
                        ...
                        <div class="u-form-select-wrapper">
                            <select id="select-027c" name="curso"
                                class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
                                <option value="Seguro de motorista">FORMAÇÃO EM CONDUÇÃO DEFENSIVA NO TRANSPORTE DE
                                    CARGA</option>
                                <option value="Seguro de motorista">FORMAÇÃO EM CONDUÇÃO DEFENSIVA NO TRANSPORTE
                                    COLETIVO DE PASSAGEIRO</option>
                                <option value="Seguro de motorista">FORMAÇÃO EM TRANSPORTE DE CARGA/PRODUTOS PERIGOSOS
                                </option>
                                <option value="Seguro de motorista">FORMAÇÃO EM ARRUMAÇÃO DE CARGA</option>
                                <option value="Seguro de motorista">FORMAÇÃO EM CONDUÇÃO DE VEÍCULOS DE EMERGÊNCIA
                                </option>
                                <option value="Seguro de motorista">PSICOLOGIA DE TRÂNSITO E PREVENÇÃO ACIDENTES
                                </option>
                                <option value="Seguro de motorista">FORMAÇÃO EM PRIMEIROS SOCORROS</option>
                                <option value="Seguro de motorista">FORMAÇÃO HIGIENE
                                    , SEGURANÇA NO TRABALHO-MOTORISTAS</option>
                            </select>
