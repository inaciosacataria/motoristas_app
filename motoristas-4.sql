...
INSERT INTO `empregadors` (`id`, `user_id`, `telefone`, `telefone_alt`, `website`, `endereco`, `sector_actividade`, `sector_especificado`, `provincia_id`, `sobre`, `empresa`, `representante`, `estado`, `documento_nuit`, `documento_certidao`, `documento_inicio_actividade`, `created_at`, `updated_at`) VALUES
(4, 5, '846411171', NULL, NULL, 'Av. 24 de julho', 'transporte', NULL, 1, NULL, 'decode', 'inacio sacataria', 'Aprovado', 'uploads/5-documento_nuit-1772537903.pdf', 'uploads/5-documento_certidao-1772537903.pdf', 'uploads/5-documento_inicio_actividade-1772537903.pdf', '2026-03-03 09:37:59', '2026-03-03 09:49:04');
...
(1, 'Banner Superior - Empregador', 'banner-empregador-top', '<div class=\"rounded-lg overflow-hidden shadow-md bg-gradient-to-r from-green-600 to-green-700 text-white p-6 text-center\"><p class=\"text-lg font-semibold\">Portal Motoristas</p><p class=\"text-sm opacity-90\">Encontre os melhores motoristas para sua empresa.</p><a href=\"/\" class=\"inline-block mt-2 px-4 py-2 bg-white text-green-700 rounded-lg font-medium hover:bg-green-50\">Saiba mais</a></div>', 'HTML', NULL, NULL, NULL, 0, 0, 1, NULL, '2026-03-03 09:14:15', '2026-03-03 09:14:15'),
(2, 'Banner Inferior - Empregador', 'banner-empregador-bottom', '<div class=\"rounded-lg overflow-hidden shadow-md bg-gray-800 text-white p-6 text-center\"><p class=\"text-lg font-semibold\">Central de Risco</p><p class=\"text-sm text-gray-300\">Consulte e registe denúncias de motoristas.</p><a href=\"/centralRisco\" class=\"inline-block mt-2 px-4 py-2 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700\">Aceder</a></div>', 'HTML', NULL, NULL, NULL, 0, 0, 1, NULL, '2026-03-03 09:14:15', '2026-03-03 09:14:15');
...
(5, 'decode', 'inaciosacataria@gmail.com', '846411171', NULL, 'activo', '$2y$10$WGlIU8jZXIDMpzYbeazYhecZIH5urxx370ujqgHi2cNIq4FrqvBH2', 'no', 0, NULL, 'empregador', 'none', NULL, '2026-03-03 09:37:59', '2026-03-03 09:37:59');
